  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="bg-input/30 border-input/30 h-8! rounded-lg! shadow-none! *:data-[slot=input-group-addon]:pl-2!">
        ...
        />
        <InputGroupAddon>
          <SearchLg className="size-4 shrink-0 opacity-50" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  );
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <Check className="ml-auto hidden opacity-0 group-has-[[data-slot=command-shortcut]]/command-item:hidden group-data-[checked=true]/command-item:opacity-100 group-data-[checked=true]/command-item:block" />
    </CommandPrimitive.Item>
  );
}
